...
st.session_state["my_input"]  = st.sidebar.file_uploader("Choose a file")
if st.session_state["my_input"]  is not None:
    ...
    selected_user_button=st.sidebar.button("Show Analysis")
    st.session_state["my_input1"]=selected_user_button


    if selected_user_button:
        # Stats Area
